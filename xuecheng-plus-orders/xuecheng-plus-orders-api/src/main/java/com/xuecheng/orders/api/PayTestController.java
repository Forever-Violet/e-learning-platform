...
public class PayTestController {
    ...
    public void doPost(HttpServletRequest httpServletRequest,
                       HttpServletResponse httpServletResponse) throws ServletException, IOException, AlipayApiException {
        // 获取初始化的AlipayClient
        ...
        alipayRequest.setBizContent("{" +
                "    \"out_trade_no\":\"202210100010181057\"," +
                "    \"total_amount\":0.1," +
                "    \"subject\":\"Iphone6 16G\"," +
    ...
    public void paynotify(HttpServletRequest request,HttpServletResponse response) throws IOException,
        ...
        for (Iterator iter = requestParams.keySet().iterator(); iter.hasNext();) {
            ...
            // 乱码解决, 这段代码在出现乱码前使用。如果mysign和sign不相等也可以使用这段代码转化
        ...
        boolean verify_result =
                AlipaySignature.rsaCheckV1(params, ALIPAY_PUBLIC_KEY, AlipayConfig.CHARSET, "RSA2");

        if (verify_result) { //如果验证成功
            //////////////////////////////////////////////////////////////////////////////////////////
            //请在这里加上商户的业务逻辑程序代码
