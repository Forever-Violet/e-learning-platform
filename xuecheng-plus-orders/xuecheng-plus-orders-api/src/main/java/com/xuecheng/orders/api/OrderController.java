...
public class OrderController {
    ...
    public PayRecordDto generatePayCode(@RequestBody AddOrderDto addOrderDto) {
        ...
        // 调用service, 完成插入订单信息(只有一条)、插入支付记录(如果支付失败会重复生成记录)、生成支付二维码
    ...
    public void requestPay(String payNo, HttpServletResponse response) throws IOException {
        ...
        AlipayClient client = new DefaultAlipayClient(AlipayConfig.URL, APP_ID, APP_PRIVATE_KEY
        ...
        alipayRequest.setBizContent("{" +
                " \"out_trade_no\":\""+payRecord.getPayNo()+"\"," +     //本系统中的支付流水号
                " \"total_amount\":\""+payRecord.getTotalPrice()+"\"," +    // 商品金额
    ...
    public PayRecordDto payResult(String payNo) throws IOException {
        ...
        // 调用支付宝接口查询 支付结果, 当支付成功后, 更新支付记录表和订单表的状态为支付成功
