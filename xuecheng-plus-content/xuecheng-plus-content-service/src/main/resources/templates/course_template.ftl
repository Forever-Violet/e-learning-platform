        ...
        <div class="article-box">
            ...
            <div class="articleItem" style="display: none">
                <div class="article-cont-catalog">
                    <div class="article-left-box">
                        <div class="content">
                            <#list model.teachplans as firseNode>
                                <div class="item">
                                    <div class="title act"><i class="i-chevron-top"></i>${firseNode.pname}<span class="time">x小时</span></div>
                                    <div class="drop-down" style="height: 260px;">
                                        <ul class="list-box">
                                            <#list firseNode.teachPlanTreeNodes as secondNode>
        ...
        <div class="popup-pay-box">
            ...
            <div class="content">
                ...
                <div class="info">
                    ...
                    <p class="info-pic">课程价格 : <span>￥${model.courseBase.originalPrice!''}</span></p>
                    <p class="info-new-pic">优惠价格 : <span>￥${model.courseBase.price!''}</span></p>
                </div>
            </div>
            <div class="fact-pic">
                实际支付: <span>￥${model.courseBase.price!''}</span></div>
